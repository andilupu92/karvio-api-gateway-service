...
@RestController
public class NotificationFallbackController {

    private static final Logger log = LoggerFactory.getLogger(NotificationFallbackController.class);

    private final Counter fallbackCounter;
    private final Timer fallbackTimer;

    public NotificationFallbackController(MeterRegistry registry) {
        this.fallbackCounter = Counter.builder("gateway.fallback.count")
                .description("Number of fallback responses returned by gateway")
                .tag("service", "karvio-notification-service")
                .register(registry);
    ...
    @RequestMapping("/fallback/karvio-notification-service-fallback")
    public Mono<ResponseEntity<Map<String, Object>>> handleFallback(ServerWebExchange exchange) {
        ...
        try {
            log.warn("Fallback triggered for route karvio-notification-service; path={} method={}",
            ...
            Map<String, Object> body = Map.of(
                    ...
                    "service", "karvio-notification-service",
